        ...
        function($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
            ...
            .state('app.users', {
                ...
                .state('app.users.manage', {
                    url: '/manage',
                    templateUrl: 'tpl/users/manage.html',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'dataTables'
                ...
                .state('app.car-inventory',{
                    url: '/car-inventory',
                    template: '<div ui-view></div>'

                })
                .state('app.car-inventory.cars',{
                    url: '/cars',
                    templateUrl:'tpl/car-inventory/cars.html',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'dataTables'
                ...
                .state('app.car-inventory.add',{
                    url: '/add',
                    templateUrl:'tpl/car-inventory/add.html'
                })

                .state('app.car-inventory.update',{
                    url: '/update',
                    templateUrl:'tpl/car-inventory/update.html'
                })
                ...
                .state('app.types-rates',{
                    url: '/types-rates',
                    template: '<div ui-view></div>'

                })
                .state('app.types-rates.type',{
                    url: '/types',
                    templateUrl:'tpl/types-rates/types.html',
                    resolve: {
                        deps: ['$ocLazyLoad', function($ocLazyLoad) {
                            return $ocLazyLoad.load([
                                'dataTables'
                ...
                .state('app.types-rates.update', {
                    url: '/update',
                    templateUrl: 'tpl/types-rates/update.html'
                })
